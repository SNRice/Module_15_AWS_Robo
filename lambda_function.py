...
def validate_data(age, dollar, intent_request):
    """
    ...
    if age is not None:
        ...
        if age < 0 or age >= 65:
            return build_validation_result(
                False,
                "age",
                "Your age should be between 1 and 64 years of age to use this service, "
                "please provide a different age.",
            )

    # Validate the investment amount, it should be >= 5000
    if dollar is not None:
        dollar = parse_int(dollar)  # Since parameters are strings it's important to cast values
        if dollar < 5000:
            return build_validation_result(
                False,
                "investmentAmount",
...
def recommend_portfolio(intent_request):
    ...
    return close(
        ...
        "Fulfilled",
        {
            ...
            "content": f"Thank you for your information; based on the risk level you defined, my recommendation is to choose an investment portfolio with {initial_recommendation}."
        },
    )
